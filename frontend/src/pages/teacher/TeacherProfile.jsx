      ...
      <div className="card p-6">
        ...
        {editing ? (
          ...
          <div className="mt-4">
            ...
            <InfoRow label="Phone (Use Login)" value={p.phone} />
          ...
          : (
            <div className="mt-4 space-y-2">
              {permissions.map(pm => {
                ...
                return (
                  <div key={pm.id}
                    className={`flex items-center justify-between rounded-xl border px-4 py-3 ${isExpired ? 'bg-rose-50 border-rose-200' :
