...
const TEACHER_NAV = [
  ...
  { label: 'School Events',       icon: Trophy,          to: '/teacher/events'     },
...
const ADMIN_NAV = [
  ...
  { label: 'Subject Management',  icon: ClipboardList,   to: '/admin/subjects'         },
  ...
  { label: 'Completion Report',   icon: ClipboardList, to: '/admin/completion-report' },
